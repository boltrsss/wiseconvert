  ...
  // ===== Image converters =====
  {
    ...
    longDescription: {
      en: [
        ...
        "No software installation, no registration. Upload your images, choose PNG as the output format, and download your converted files in seconds.",
      ],
      zh: [
