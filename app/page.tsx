    ...
    <div className="min-h-screen flex flex-col bg-slate-50 text-slate-900">
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-b from-white to-slate-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-20 grid lg:grid-cols-3 gap-10 lg:gap-8 items-start">
            {/* Left: text */}
            <div className="lg:col-span-2">
              ...
              <p className="text-slate-600 text-base sm:text-lg mb-6">
                WiseConvert lets you convert images, videos, audio and
                documents with a simple drag &amp; drop interface. Fast, secure
                and free to start.
              </p>
            ...
            {/* Right: uploader + 🟡 Ad Slot 2（側邊 300x250） */}
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-4 sm:p-6 lg:p-7">
                ...
                {/* Dropzone (之後可換成你自己的 <FileUpload /> 或 <UploadDropzone />) */}
