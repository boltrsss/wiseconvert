        ...
        >
          <div className="max-w-screen-2xl mx-auto px-6 lg:px-10">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { step: 1, titleKey: "how_it_works.step1_title", descKey: "how_it_works.step1_desc" },
                { step: 2, titleKey: "how_it_works.step2_title", descKey: "how_it_works.step2_desc" },
                { step: 3, titleKey: "how_it_works.step3_title", descKey: "how_it_works.step3_desc" },
                { step: 4, titleKey: "how_it_works.step4_title", descKey: "how_it_works.step4_desc" },
              ].map((item) => (
                <div
                  key={item.step}
